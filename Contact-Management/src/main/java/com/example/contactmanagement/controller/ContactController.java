...
public class ContactController {
	...
	public ResponseEntity<List<ContactResponse>> getContactByFirstName(@PathVariable("firstName") String firstName)
	{
		List<ContactResponse> contacts = contactService.searchContactByFirstName(firstName);
		return new ResponseEntity<List<ContactResponse>>(contacts, HttpStatus.OK);
		
	}
	
	@GetMapping("/lastName/{lastName}")
	public ResponseEntity<List<ContactResponse>> getContactByLastName(@PathVariable("lastName") String lastName)
	{
		List<ContactResponse> contacts = contactService.searchContactByLastName(lastName);
		return new ResponseEntity<List<ContactResponse>>(contacts, HttpStatus.OK);
		
	}
	
	@GetMapping("/email/{email}")
	public ResponseEntity<List<ContactResponse>> getContactByEmail(@PathVariable("email") String email)
	{
		List<ContactResponse> contacts = contactService.searchContactByEmail(email);
		return new ResponseEntity<List<ContactResponse>>(contacts, HttpStatus.OK);
